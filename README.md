...
| `test_for_ode.py` | **Application to ODEs.** Applies the "Differentiation-then-Regression" strategy to a confounded Michaelis-Menten Kinetics system, demonstrating the recovery of physical parameters from trajectory data. | Experiment 4 |
